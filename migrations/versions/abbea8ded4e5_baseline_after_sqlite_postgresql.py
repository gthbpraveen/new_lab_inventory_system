"""Baseline after SQLite → PostgreSQL

Revision ID: abbea8ded4e5
Revises: 4820c21cfb55
Create Date: 2025-09-18 11:24:47.630814
...
revision = 'abbea8ded4e5'
down_revision = '4820c21cfb55'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('indenter', sa.String(length=100), nullable=True),
    sa.Column('department_code', sa.String(length=200), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
